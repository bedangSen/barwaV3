 ...
 * @param {Boolean} [params.passages=true] BETA - A boolean that specifies whether the service returns a set of the most relevant passages from the documents returned by a query.  The passages parameter works only on private collections. It does not work in the Watson Discovery News collection.
 ...
 * @param {Number} [params.passages.count=100] The maximum number of passages to return. The search will return fewer if that is the total number found. The default is 10. The maximum is 100.
 * @param {Number} [params.passages.characters=2000] The approximate number of characters that any one passage should have. The default is 400. The minimum is 50. The maximum is 2000.
 */
...
//v1/environments/f2cb69d1-6b28-4342-81a6-d02c1d4d9a71/collections/dfdd0114-0b36-4c6e-b858-d96a3dc491a8/query?version=2017-11-07&deduplicate=false&highlight=true&passages=true&passages.count=5&passages.characters=2000&natural_language_query=What%20are%20the%20conditions%20and%20required%20forms%20for%20the%20vehicles%20Murabaha%20%28cars%29%3F

  const parameters = {
    options: {
      url: '/v1/environments/{environment_id}/collections/{collection_id}/query?version=2017-11-07&passages=true&passages.count=1&passages.characters=465',
      method: 'GET',
      json: true,
      path: pick(params, ['environment_id', 'collection_id']),
      qs: pick(params, [
